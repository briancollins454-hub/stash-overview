...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const ALLOWED_TABLES = ['stash_orders', 'stash_mappings', 'stash_stock', 'stash_returns', 'stash_reference_products', 'stash_links', 'stash_product_mappings', 'stash_job_links', 'stash_product_patterns', 'stash_deco_jobs', 'stash_settings', 'order_notes', 'stash_finance_cache', 'stash_deco_stitch_cache', 'stash_production_issues', 'stash_wholesaler_prices', 'stash_daily_tasks', 'stash_priority_notes', 'stash_stock_take_sessions', 'stash_stock_take_lines'];
