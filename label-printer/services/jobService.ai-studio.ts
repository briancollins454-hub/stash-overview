/**
 * Drop-in replacement for AI Studio hosting (no Vite env vars).
 * Rename to jobService.ts or replace mockJobService.ts in your AI Studio project.
 */
import { Job } from '../types';

const API_URL = 'https://www.stashoverview.co.uk/api/label-printer';
