...
const GoogleUserManagement: React.FC<{ user: any }> = ({ user }) => {
  ...
  const googleUser: import('./components/UserManagement').AppUser = {
    ...
    allowedTabs: ['dashboard','command','kanban','intelligence','production','reports','operations','stock','efficiency','mto','deco','revenue','autolink','fulfill','analyst','finance','sales','users','manual','alerts','settings','briefing','priority'],
  };
...
const App: React.FC = () => {
  ...
  const validTabs = ['dashboard', 'stock', 'efficiency', 'mto', 'deco', 'analyst', 'guide', 'widget', 'kanban', 'intelligence', 'alerts', 'production', 'reports', 'operations', 'revenue', 'autolink', 'fulfill', 'finance', 'sales', 'users', 'manual', 'command', 'briefing', 'priority'];
